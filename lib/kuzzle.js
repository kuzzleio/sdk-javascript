(function (root, factory) {
  // as web browser AMD/RequireJS module
  ...
  // as <script src="path/to/kuzzle/kuzzle.js"></script>
    ...
    if (typeof io === 'undefined') {
      console.error('SocketIO dependency for Kuzzle not found.');
    }
  ...
  if (typeof io === 'undefined') {
    if (typeof define === 'function' && define.amd) {
      console.error('SocketIO dependency not found');
      return false;
    }
    // as Node.js common.js module
    else if (typeof module === 'object' && module.exports) {
      console.error('Unable to load SocketIO dependency');
      return false;
    }
  }
