...
describe("Observer", () => {
  ...
  beforeEach(() => {
    ...
    sdk = {
      document: {
        ...
        mGet: sinon
          .stub()
          .resolves({ successes: [doc1, doc2], errors: [error1] }),
  ...
  describe("#stop", () => {
    it("should call disposeDocuments", async () => {
      ...
      should(observer.disposeDocuments).be.called("index", "collection", [
        doc1,
      ]);
    });
  ...
  describe("#disposeDocuments", () => {
    it("should delete documents and watch collection", async () => {
      ...
      const observedDocuments =
        observer.documentsByCollection.get("index:collection");
  ...
  describe("#disposeAll", () => {
    it("should delete documents and unsubscribe (mode realtime)", async () => {
      ...
      observer.documentsByCollection.get("index:collection").roomId = "roomId";
      observer.documentsByCollection.get("index:collection2").roomId =
        "roomId2";
  ...
  describe("#get", () => {
    it("should use Document.get and observe returned document", async () => {
      ...
      should(sdk.document.get).be.calledWith(
        "index",
        "collection",
        "id",
        "opts",
  ...
  describe("#search", () => {
    it("should use Document.search then build and start search result", async () => {
      ...
      const result = await observer.search(
        "index",
        "collection",
        query,
        options,
  ...
  describe("#pullingHandler", () => {
    ...
    it("should use set the delete flag", async () => {
      ...
      should(sdk.document.mGet).be.calledWith("index", "collection1", ["doc1"]);
