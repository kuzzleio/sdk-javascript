var
  ...
  KuzzleProfile = require('../../../src/security/kuzzleRole'),
  KuzzleUser = require('../../../src/security/kuzzleRole');

describe('KuzzleSecurity methods', function () {
  var
    kuzzle,
    expectedQuery,
    result,
