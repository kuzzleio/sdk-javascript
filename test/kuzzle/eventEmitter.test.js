...
describe("Event emitter", () => {
  const stubListener1 = sinon.stub(),
  ...
  describe("#addListener", () => {
    it("should properly add new listeners to events", () => {
      ...
      should(kuzzleEventEmitter.listeners("foo"))
        ...
        .and.have.length(2);
      should(kuzzleEventEmitter.listeners("bar"))
        .eql([listener3])
        .and.have.length(1);
    });
  ...
  describe("#prependListener", () => {
    it("should properly add new listeners to the top of the event list", () => {
      ...
      should(kuzzleEventEmitter.listeners("foo"))
        .eql([listener3, listener2, listener1])
        .and.have.length(3);
    });
  });
  ...
  describe("#once", () => {
    it("should register listeners only for 1 time", () => {
      ...
      should(kuzzleEventEmitter.listeners("foo"))
        .eql([listener1, listener2, listener3])
        .and.have.length(3);
  ...
  describe("#prependOnceListener", () => {
    it("should prepend listeners only for 1 time", () => {
      ...
      should(kuzzleEventEmitter.listeners("foo"))
        .eql([listener3, listener1, listener2])
        .and.have.length(3);
  ...
  describe("#removeListener", () => {
    ...
    it("should remove any one listener from the listener list", () => {
      ...
      should(kuzzleEventEmitter.listeners("foo"))
        .eql([listener1, listener3])
        .and.have.length(2);
      should(kuzzleEventEmitter.listeners("bar"))
        .eql([listener1, listener2])
        .and.have.length(2);
      should(kuzzleEventEmitter.listeners("baz"))
        .eql([listener3])
        .and.have.length(1);
    });
  ...
  describe("#emit", () => {
    ...
    it("should allow providing any number of arguments", () => {
      ...
      should(stubListener1).be.calledOnce();
      should(stubListener1.firstCall.args)
        .eql(["bar", ["foo", "bar"]])
        .and.have.length(2);
